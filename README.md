...
> [!IMPORTANT]
> 本仓库是基于 [Sliverkiss/workbuddy2api](https://github.com/Sliverkiss/workbuddy2api) 的公开修改版；部分能力参考社区增强分支 [287775856/workbuddy2api](https://github.com/287775856/workbuddy2api)。
>
> - 原始项目作者：`Sliverkiss`
> - 社区增强分支：`287775856`
> - 本修改：
