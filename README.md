...
> [!IMPORTANT]
> 本仓库是基于 [Sliverkiss/workbuddy2api](https://github.com/Sliverkiss/workbuddy2api) 的公开修改版，并参考了社区增强分支 [287775856/workbuddy2api](https://github.com/287775856/workbuddy2api) 的 `/v1/stats` 等能力。
>
> - 原始项目作者：`Sliverkiss`
> - 社区增强分支：`287775856`
> - 本修改：定时签到、猫猫旅行等国内活动跳过国际版（`workbuddy.ai`）账号，避免对国际版调用不存在的活动接口并触发无意义的熔断。
>
> 本仓库仅用于学习、研究和个人授权账号的私有环境测试，使用前请阅读下方安全与合规说明。
